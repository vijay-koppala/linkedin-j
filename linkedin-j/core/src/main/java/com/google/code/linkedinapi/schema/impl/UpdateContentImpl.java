    ...
    implements Serializable, UpdateContent
{
    ...
    @XmlElement(name = "company-product-update", type = CompanyProductUpdateImpl.class)
    protected CompanyProductUpdateImpl companyProductUpdate;
    ...
    public CompanyProductUpdate getCompanyProductUpdate() {
        return companyProductUpdate;
    }

    public void setCompanyProductUpdate(CompanyProductUpdate value) {
        this.companyProductUpdate = ((CompanyProductUpdateImpl) value);
    }
